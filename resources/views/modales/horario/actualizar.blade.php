<form action="{{route('acthorario.update')}}" method="POST" enctype="multipart/form-data">
    <!-- Modal -->
    <div class="modal fade" id="modaleactualizar{{$item->id_horario}}" tabindex="-1">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalLabel">Actualizar Horario</h1>    
          </div>
                                  ...
                                  <form class="user">
                                      <div class="form-group">
                                          <input type="text" class="form-control form-control-user" name="cod"
                                              placeholder="DNI" @readonly(true) value="{{$item->codigo}}">
                                      </div>
                                      <div class="form-group row">
                                          <div class="col-sm-6 mb-3 mb-sm-0">
                                              <input type="text" class="form-control form-control-user" name="hi"
                                                  ...
                                                  title="Por favor ingrese una hora válida en formato HH:MM" required value="{{$item->hora_ingreso}}">
                                                  
                                          </div>
                                          <div class="col-sm-6">
                                              <input type="text" class="form-control form-control-user" name="hs"
                                                  placeholder="Hora Salida" pattern="([01]?[0-9]|2[0-3]):[0-5][0-9]"
                                                  title="Por favor ingrese una hora válida en formato HH:MM" required value="{{$item->hora_salida}}">
